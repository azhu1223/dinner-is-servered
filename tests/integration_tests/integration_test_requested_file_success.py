...
request_file = "/oof.txt"
expected_output_folder = "../resources/text"
expected_output_name = "/oof.txt"
...
def main():
    ...
    curl_process = sp.Popen(["curl", "localhost:80" + request_path, "-s"], stdout=sp.PIPE)
