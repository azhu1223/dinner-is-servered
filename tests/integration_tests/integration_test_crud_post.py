...
expected_output_name = "/successful_POST_output"
...
def main():
    ...
    # curl_process = sp.Popen(["curl", "-isd", "test", "localhost:80/api/test"], stdout=sp.PIPE)
    os.system(f"curl -isd test localhost:80/api/test > temp.txt")
